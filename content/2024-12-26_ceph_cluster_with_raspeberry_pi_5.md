...
Kubernetes cluster I built a [Ceph](https://ceph.io/) cluster as storage solution. This time I did not want to do this
...
I found it quite usefull to use the customization options of Raspberry Pi imager and provision hostnames and SSH keys
...
I already threw in some harddrives in my Proxmox machine and plan to set up another Ceph cluster there. I am interested
